        ...
        <div class="board-column-expanded board-column-expanded-header">
            ...
            <span class="pull-right">
                <?php if ($swimlane['nb_swimlanes'] > 1 && ! empty($column['column_score'])): ?>
                    <span class="swimlane-bracket-number" title="<?= t('Total score in this column across all swimlanes') ?>">
            ...
            <span class="swimlane-bracket-number" title="<?= t('Total number of tasks in this column across all swimlanes') ?>" class="board-column-header-task-count">
